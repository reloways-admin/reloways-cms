...
export interface ApiKnowledgeArticleKnowledgeArticle
  ...
  info: {
    ...
    pluralName: 'knowledge-articles';
    singularName: 'knowledge-article';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    ContentBlocks: Schema.Attribute.DynamicZone<
      [
        ...
        'knowledge.smart-checklist-picker',
        'category.disclaimer',
      ]
    > &
      Schema.Attribute.SetPluginOptions<{
    ...
    >;
    metaSEO: Schema.Attribute.Component<'shared.meta-seo', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiKnowledgeCategoryKnowledgeCategory
  extends Struct.CollectionTypeSchema {
...
export interface ApiMissionTagMissionTag extends Struct.CollectionTypeSchema {
  collectionName: 'mission_tags';
  info: {
    displayName: 'Mission Tag';
    pluralName: 'mission-tags';
    singularName: 'mission-tag';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    >;
    missionTag: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPersonPerson extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    IsExpert: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiTaskTask extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    depends_ons: Schema.Attribute.Relation<'manyToMany', 'api::task.task'>;
    ...
    missionTags: Schema.Attribute.Relation<
      ...
      'api::mission-tag.mission-tag'
    >;
    nameTask: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
