...
export interface ApiKnowledgeArticleKnowledgeArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Category: Schema.Attribute.Relation<'oneToOne', 'api::knowledge-category.knowledge-category'>;
